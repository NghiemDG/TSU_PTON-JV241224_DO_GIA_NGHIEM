...
public class HibernateConfig {
    ...
    public SessionFactory sessionFactory() {
        ...
        sessionBuilder.scanPackages("ra.project.entity"); // package containing your entity classes
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/project?createDatabaseIfNotExist=true");// replace with your database URL
        dataSource.setUsername("root");// replace with your database username
        dataSource.setPassword("111111"); // replace with your database password
        return dataSource;
    }
